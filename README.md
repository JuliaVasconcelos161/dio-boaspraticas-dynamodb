...
aws dynamodb query \
    ...
    --expression-attribute-values  '{":name":{"S":"Equals"}}'
```
...
aws dynamodb query \
    ...
    --expression-attribute-values  '{":v_artist":{"S":"Ed Sheeran"},":v_title":{"S":"Plus"} }'
```
...
aws dynamodb query \
    ...
    --expression-attribute-values  '{":v_song":{"S":"Shivers"},":v_year":{"S":"2021"} }'
```
